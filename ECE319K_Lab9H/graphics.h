...
#define maxTurnSpeed 7
#define maxMoveSpeed 3
#define cameraClippingRadius 4
#define UI_HEIGHT 15
#define enemySize 40
#define deadAnimLength 5
#define minimapWidth 40
#define minimapHeight 50

const int heightScale = minimapHeight / mapHeight;
const int widthScale = minimapWidth / mapWidth;
...
const uint16_t playerColor = ST7735_Color565(255, 255, 255);
const uint16_t enemyAColor = ST7735_Color565(0, 255, 0);
const uint16_t enemyBColor = ST7735_Color565(255, 0, 0);
const uint16_t enemyCColor = ST7735_Color565(0, 200, 255);
const uint16_t ceilingColor = ST7735_Color565(68, 68, 68);
const uint16_t floorColor = ST7735_Color565(122, 122, 122);
const uint16_t heartColor = ST7735_Color565(255, 0, 0);
const uint16_t ammoColor = ST7735_Color565(255, 148, 7);
...
{blue16, empty16, empty16, red16, empty16, empty16, empty16, blue16},
{blue16, empty16, empty16, empty16, empty16, empty16, empty16, blue16},
{blue16, empty16, red16, empty16, empty16, yellow16, empty16, blue16},
{blue16, empty16, empty16, empty16, empty16, empty16, empty16, blue16},
{blue16, empty16, red16, empty16, empty16, yellow16, empty16, blue16},
{blue16, empty16, empty16, empty16, empty16, empty16, empty16, blue16},
{blue16, empty16, empty16, green16, green16, empty16, empty16, blue16},
{blue16, empty16, empty16, empty16, green16, empty16, empty16, blue16},
{blue16, blue16, blue16, blue16, blue16, blue16, blue16, blue16}
};
