...
// I.e., PortB has already been reset and activated (do not reset PortB here again)
    // regular inputs
    IOMUX->SECCFG.PINCM[PB16INDEX]= 0x00050081;
    IOMUX->SECCFG.PINCM[PB17INDEX]= 0x00050081;
    IOMUX->SECCFG.PINCM[PB18INDEX]= 0x00050081;
    IOMUX->SECCFG.PINCM[PB19INDEX]= 0x00050081;
}
...
uint32_t Key_In(void){
    // regular Lab5
 return ((GPIOB->DIN31_0&0x000F0000) >> 16); // replace this line
